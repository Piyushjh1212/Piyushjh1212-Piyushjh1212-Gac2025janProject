...
import "./create_add_video.css"; // Ensure you have a CSS file
import { GacContext } from "../../Context/Gaccontext";
import VideoUpload from "../../Uploader/VidoeUploader/VidoeUpload";
import CourseRendering from "../CourseRendering/CourseRendering";

export default function Create_add_vedio() {
