...
import { ChevronDown, ChevronRight, Play, CheckCircle2, Lock, Star } from 'lucide-react'
...
const CoursesSidebar = ({ 
  ...
  const [expandedModules, setExpandedModules] = useState([selectedCourse.modules[0].id])
  ...
  const isLessonLocked = (lesson, moduleIndex, lessonIndex) => {
    ...
    return !allPreviousLessons.every(lesson => completedLessons.includes(lesson.id))
  }
                ...
                <div className="course-info">
                  ...
                  <div className="course-meta">
                    <span 
                      ...
                      style={{ backgroundColor: getDifficultyColor(course.level) }}
                    >
                      {course.level}
                    </span>
            ...
            {selectedCourse.modules.map((module, moduleIndex) => (
              <div key={module.id} className="module-item">
                ...
                >
                  ...
                  <span className="lessons-count">{module.lessons.length} lessons</span>
                </div>
