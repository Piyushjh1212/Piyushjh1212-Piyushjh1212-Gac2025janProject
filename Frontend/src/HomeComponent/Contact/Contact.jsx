...
// const [formData, setFormData] = useState({name: "", email: "", message: ""}); // state hai and hook bhi use hua hai - usestate

// yhna pe [e.target.name] => useState({name: "", email: "", message: ""}); ye name, email message le rha hai or
// e.target.value ye wo update value hai jo user update kreaga dynamically
