...
router.get("/generate-pdf", (req, res) => {
  const order = {
    ...
    items: [
      { description: "Notebook x3", price: 4.0, quantity: 3 },
      { description: "Pencil case", price: 6.0, quantity: 1 },
      { description: "Scissors", price: 3.0, quantity: 1 },
    ],
    total: 21.0, // This can be calculated dynamically if needed
  };
